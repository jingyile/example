...
<form name="form1" method="post" action="itemAdd.action">
  <table width="600" border=0 align=center cellpadding=5 cellspacing=0>
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">新增栏目</th>
      </tr>
      <tr bgcolor="#DEE5FA">
      ...
      <tr align="center" bgcolor="#DEE5FA">
        <td align="center" class="txlrow" width="150"><div align="right">栏目名称：</div></td>
      ...
      <tr bgcolor="#DEE5FA">
        <td align="center" class="txlrow"><div align="right">栏目介绍：</div></td>
        <td align="center" class="txlrow"><div align="left">
          <input name="itemDescription" type="text" size="50">
        </div></td>
      </tr>
      <tr bgcolor="#DEE5FA">
        <td align="center" class="txlrow"><div align="right">栏目版主：</div></td>
        <td align="center" class="txlrow"><div align="left">
